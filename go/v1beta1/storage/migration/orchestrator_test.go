...
var _ = Describe("Orchestrator", func() {
	...
	Describe("RunMigrations", func() {
		...
		Describe("there are migrations to run", func() {
			BeforeEach(func() {
				migrator.migrations = []*esutil.IndexInfo{
					createFakeIndexInfo(),
					createFakeIndexInfo(),
					createFakeIndexInfo(),
				}
...
func (fm *fakeMigrator) GetMigrations(_ context.Context) ([]*esutil.IndexInfo, error) {
...
func (fm *fakeMigrator) Migrate(_ context.Context, migration *esutil.IndexInfo) error {
...
func createFakeIndexInfo() *esutil.IndexInfo {
